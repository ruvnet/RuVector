...
// A real install smoke test for earth-pulse-harness.
//
...
// fastest signal that `npm install` produced a runnable harness. The science
// pipeline has its own offline suite in __tests__/pipeline.test.ts.
...
describe('earth-pulse-harness — install smoke test', () => {
