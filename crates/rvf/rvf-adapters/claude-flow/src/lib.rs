...
//! store.ingest_memory("user-preference", "dark-mode", Some("ui"), &embedding).unwrap();
//!
...
pub use memory_store::{MemoryEntry, MemoryResult, MemoryStoreError, RvfMemoryStore};
pub use witness::WitnessWriter;
