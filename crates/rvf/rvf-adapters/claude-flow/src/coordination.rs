//! Swarm coordination state management for Claude-Flow RVF adapter.  
//!  
//! Tracks agent state changes and consensus votes in-memory, with the  
//! coordination state intended to be serialized alongside the RVF store.  
//! State entries and votes are appended chronologically for audit and replay.  
